              ...
              <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-full p-1">
                <button
                  ...
                  className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${
                    !isAnnual ? "bg-white text-primary" : "text-white/80 hover:text-white"
                  }`}
                >
                  Monthly
                </button>
                ...
                >
                  Annual <span className="text-secondary ml-1">Save 33%</span>
                </button>
              </div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {plans.map((plan) => {
                  ...
                  const ctaLink = isFree
                    ? "/register"
                    : `/payment?plan_id=${plan.id}&billing=${isAnnual ? "annual" : "monthly"}`;
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-2xl p-8 ${
                        plan.highlighted
                          ? "bg-gradient-to-b from-secondary/10 to-coral-dark/5 border-2 border-secondary shadow-xl scale-105"
